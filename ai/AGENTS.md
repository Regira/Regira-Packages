...
| `Regira.Web*` | `Web` | Dedicated module guides | Razor rendering, middleware, visit/page-view analytics, and optional Swagger/OpenAPI auth helpers | `Regira.Web`, `Regira.Web.Analytics`, `Regira.Web.HTML.RazorEngineCore`, `Regira.Web.HTML.RazorLight`, `Regira.Web.Swagger` |
