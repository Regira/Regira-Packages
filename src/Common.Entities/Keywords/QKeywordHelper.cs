...
public class QKeywordHelper(QKeywordHelperOptions? options = null, INormalizer? normalizer = null) : IQKeywordHelper
{
    ...
    public QKeyword ParseKeyword(string? input)
    {
        ...
        var trimmedStartsWith = $"{trimmed}{Options.WildcardOutput}";
        var trimmedEndsWith = $"{Options.WildcardOutput}{trimmed}";
        ...
        return new QKeyword
        {
            ...
            Trimmed = trimmed,
            TrimmedStartsWith = trimmedStartsWith,
            TrimmedEndsWith = trimmedEndsWith,
            TrimmedQ = trimmedQ,
            TrimmedQW = trimmedQW,
